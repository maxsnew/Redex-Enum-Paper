...
(module+ test
  ...
  (check-equal? (term (ty (below/e 2))) 2)
  (check-equal? (term (ty (below/e ∞))) (term ∞))
  (check-equal? (term (ty (cons/e (below/e ∞) (below/e 11)))) (term (∧ ∞ 11)))
  (check-equal? (term (ty (cons/e (below/e 4) (below/e 11)))) (term (∧ 4 11)))
  (check-equal? (term (ty (unfair-cons/e (below/e ∞) (below/e 11)))) (term (∧ ∞ 11)))
  (check-equal? (term (ty (unfair-cons/e (below/e 4) (below/e 11)))) (term (∧ 4 11)))
  (check-equal? (term (ty (or/e (below/e 4) (below/e 11)))) (term (∨ 4 11)))
  (check-equal? (term (ty (dep/e inf (below/e ∞) (nat->map-of-swap-zero-with ∞)))) (term (∧ ∞ ∞)))
  (check-equal? (term (ty (dep/e fin (below/e 10) (nat->map-of-swap-zero-with 11))))
                (term (∧ 10 11)))
  (check-equal? (term (ty (except/e (below/e 10) 3))) (term (- 10 3)))
  (check-equal? (term (ty (except/e (below/e ∞) 3))) (term (- ∞ 3)))
  (check-equal? (term (ty (except/e (cons/e (below/e 10) (below/e 11)) (cons 2 3))))
                (term (- (∧ 10 11) (cons 2 3))))
  (check-equal? (term (ty (except/e (or/e (below/e ∞) (cons/e (below/e 10) (below/e 11))) (inl 11))))
                (term (- (∨ ∞ (∧ 10 11)) (inl 11))))
  (check-equal? (term (ty (except/e (or/e (below/e ∞) (cons/e (below/e 10) (below/e 11)))
                                     (inr (cons 1 1)))))
                (term (- (∨ ∞ (∧ 10 11)) (inr (cons 1 1)))))
  (check-equal? (term (ty (fix/e x (below/e ∞)))) (term (μ x ∞)))
  (check-equal? (term (ty (fix/e x (or/e (cons/e (below/e ∞) x) (below/e ∞)))))
                (term (μ x (∨ (∧ ∞ x) ∞))))
  (check-equal? (term (ty (map/e swap-cons swap-cons (cons/e (below/e ∞) (below/e ∞)))))
                (term (∧ ∞ ∞)))
